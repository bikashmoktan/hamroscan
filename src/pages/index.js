...
const IndexPage = () => {
  return (
    <Layout pageTitle="Home Page">
      ...
      <p>
        And do not ask philosophical questions. Philosophical questions only seem to be questions, but they are not. That is why no answer has been possible. If a question is really a question then it is answerable, but if it is false, just a linguistic confusion, then it cannot be answered. Philosophy has gone on answering for centuries and centuries, but the questions still remain the same. However you answer a philosophical question you never answer it, because the question itself is false. It is not meant to be answered at all.
      </p>
      <p>
